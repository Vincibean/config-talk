```scala
private def builderMethod(
  String logoutUrl, 
  String keyStorePath, 
  String keyStorePassword,
  String privateKeyPassword,
  String idpMetadataPath,
  String samlClientName,
  String spEntityId,
  Duration maximumAuthenticationLifetime) = {
...
} builderMethod(logoutUrl, keyStorePath, keyStorePassword, privateKeyPassword, idpMetadataPath, samlClientName, spEntityId, maximumAuthenticationLifetime)
```
